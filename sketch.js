...
function obstacleSpawn(){
  if(frameCount % 55 === 0){
    ...
    switch(rand){
      case 1: obstacle.addImage(b1);
      break
      case 2: obstacle.addImage(b2);
      break
      case 3: obstacle.addImage(b3);
      break
      case 4: obstacle.addImage(b4);
      break
      case 5: obstacle.addImage(b5);
      break
      case 6: obstacle.addImage(b6);
      break
